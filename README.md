...
🌱 **Currently ...**
* *(latest)* Using GitHub Copilot to drive innovations while learning ways to deal with multi-repository projects to make better use on mid-sized scenarios of VSCode, GH Copilot and git worktrees. Check `luisgizirian/ops-defender`, `luisgizirian/compiler` repos.
