...
🌱 **Currently ...**
* *(latest)* Using GitHub Copilot to drive innovations while learning ways to deal with multi-repository projects to make better use for mid-sized scenario projects on: VSCode (ssh and devcontainer extensions), GH Copilot and git worktrees. Check `luisgizirian/ops-defender`, `luisgizirian/intent` repos.
