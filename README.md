...
🌱 **Currently ...**
* *(latest)* Using GitHub Copilot to drive innovations while learning ways to deal with multi-repository projects to make better use of VSCode and GH Copilot and git worktrees for mid-sized scenarios. Check `luisgizirian/ops-defender`, `luisgizirian/compiler` repos.
